...
namespace Randomizer.Randomizers.Game3.Misc
{
    class Cutscene
    {
        ...
        public static bool ShuffleCutscenePawns2(GameTarget target, ExportEntry export, RandomizationOption option)
        {
            ...
            var cutsceneName = SeqTools.GetParentSequence(export).ObjectName;
        ...
        {
            acceptableTagsForPawnShuffling = MERUtilities.GetEmbeddedTextAsset("allowedcutscenerandomizationtags.txt").Split(new[] { "\r\n", "\r", "\n" },
