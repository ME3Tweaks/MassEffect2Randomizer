...
namespace Randomizer.Randomizers.Game2.ExportTypes
{
    ...
    class RBioEvtSysTrackGesture
    {
        ...
        */
        ...
        {
            var gest = GestureManager.GetRandomMERGesture();
            var portedInExp2 = PackageTools.PortExportIntoPackage(target, targetPackage, gest.GestureAnimSequence);
            return new Gesture(portedInExp2);
